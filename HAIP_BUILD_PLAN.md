...
- Guest journey ops — [#182](https://github.com/telivityai/haip/pull/182) (lifecycle guest-comms triggers, communications desk, registration settings, messaging UI)
- Housekeeping ops depth — _(this PR)_ (ops desk summaries, interactive checklists, VIP priority, HK permissions)
