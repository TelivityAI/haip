...
# or:
./integrations/demos/vonage-messages/demo.sh
```

What it does:
1. Turns **ON** the property Integrations catalog toggle for `vonage-messages` (same as the dashboard button).
