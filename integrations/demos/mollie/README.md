...
```bash
./integrations/demos/run.sh mollie
# or:
./integrations/demos/mollie/demo.sh
```

What it does:
1. Turns **ON** the property Integrations catalog toggle for `mollie` (same as the dashboard button).
