...
# or:
./integrations/demos/bird/demo.sh
```

What it does:
1. Turns **ON** the property Integrations catalog toggle for `bird` (same as the dashboard button).
...
[docs/integrations/bird-sms.md](../../docs/integrations/bird-sms.md)
