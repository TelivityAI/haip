...
export class FolioController {
  ...
  // custom role (e.g. Winter Manager) has no realm role at all, so @Roles()
  // could never grant it "view folios" no matter what it was granted
  // locally. Every ROLE_DEFAULT_PERMISSIONS entry with folios.read,
  // including readonly, is meant to reach this route now.
