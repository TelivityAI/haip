...
<img src="https://img.shields.io/badge/Tests-1285%20passing-brightgreen" alt="1285 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1285 tests across 169 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1285 tests across 169 test files)
...
pnpm test             # Run all tests (1285 tests, 169 files)
pnpm lint             # ESLint
```
