...
<img src="https://img.shields.io/badge/Tests-1254%20passing-brightgreen" alt="1254 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1254 tests across 160 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1254 tests across 160 test files)
...
pnpm test             # Run all tests (1254 tests, 160 files)
pnpm lint             # ESLint
```
