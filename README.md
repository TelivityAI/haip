...
<img src="https://img.shields.io/badge/Tests-2172%20passing-brightgreen" alt="2172 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (2172 passing tests across 258 files with passing tests) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# Passing-test count: 2172 test cases across 258 files (skipped excluded)
...
pnpm test             # Run all tests (2172 passing, 258 files with passes; skipped excluded)
pnpm lint             # ESLint
```
