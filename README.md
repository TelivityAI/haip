...
<img src="https://img.shields.io/badge/Tests-1490%20passing-brightgreen" alt="1490 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1490 tests across 212 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1490 tests across 212 test files)
...
pnpm test             # Run all tests (1490 tests, 212 files)
pnpm lint             # ESLint
```
