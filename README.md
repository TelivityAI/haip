...
<img src="https://img.shields.io/badge/Tests-1323%20passing-brightgreen" alt="1323 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1323 tests across 180 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1323 tests across 180 test files)
...
pnpm test             # Run all tests (1323 tests, 180 files)
pnpm lint             # ESLint
```
