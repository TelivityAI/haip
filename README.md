...
<img src="https://img.shields.io/badge/Tests-1267%20passing-brightgreen" alt="1267 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1267 tests across 163 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1267 tests across 163 test files)
...
pnpm test             # Run all tests (1267 tests, 163 files)
pnpm lint             # ESLint
```
