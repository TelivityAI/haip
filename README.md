...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-2217%20passing-brightgreen" alt="2217 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (2217 passing tests across 265 files with passing tests) | Unit and integration tests |
...
```bash
# Passing-test count: 2217 test cases across 265 files (skipped excluded)
...
pnpm test             # Run all tests (2217 passing, 265 files with passes; skipped excluded)
pnpm lint             # ESLint
```
