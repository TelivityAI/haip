...
<img src="https://img.shields.io/badge/Tests-2215%20passing-brightgreen" alt="2215 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (2215 passing tests across 259 files with passing tests) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# Passing-test count: 2215 test cases across 259 files (skipped excluded)
...
pnpm test             # Run all tests (2215 passing, 259 files with passes; skipped excluded)
pnpm lint             # ESLint
```
