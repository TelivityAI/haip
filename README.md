...
<img src="https://img.shields.io/badge/Tests-1249%20passing-brightgreen" alt="1249 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1249 tests across 159 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1249 tests across 159 test files)
...
pnpm test             # Run all tests (1249 tests, 159 files)
pnpm lint             # ESLint
```
