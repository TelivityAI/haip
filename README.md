...
| Testing | Vitest (1261 tests across 163 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1261 tests across 163 test files)
...
pnpm test             # Run all tests (1261 tests, 163 files)
pnpm lint             # ESLint
```
