...
<img src="https://img.shields.io/badge/Tests-1451%20passing-brightgreen" alt="1451 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1451 tests across 204 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1451 tests across 204 test files)
...
pnpm test             # Run all tests (1451 tests, 204 files)
pnpm lint             # ESLint
```
