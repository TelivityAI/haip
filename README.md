...
<img src="https://img.shields.io/badge/Tests-1265%20passing-brightgreen" alt="1265 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1265 tests across 164 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1265 tests across 164 test files)
...
pnpm test             # Run all tests (1265 tests, 164 files)
pnpm lint             # ESLint
```
