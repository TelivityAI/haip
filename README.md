...
<img src="https://img.shields.io/badge/Tests-1431%20passing-brightgreen" alt="1431 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1431 tests across 201 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1431 tests across 201 test files)
...
pnpm test             # Run all tests (1431 tests, 201 files)
pnpm lint             # ESLint
```
