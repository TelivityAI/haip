...
<img src="https://img.shields.io/badge/Tests-1359%20passing-brightgreen" alt="1359 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1359 tests across 190 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1359 tests across 190 test files)
...
pnpm test             # Run all tests (1359 tests, 190 files)
pnpm lint             # ESLint
```
