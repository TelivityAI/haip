...
<img src="https://img.shields.io/badge/Tests-1361%20passing-brightgreen" alt="1361 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1361 tests across 191 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1361 tests across 191 test files)
...
pnpm test             # Run all tests (1361 tests, 191 files)
pnpm lint             # ESLint
```
