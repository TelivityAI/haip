...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-2258%20passing-brightgreen" alt="2258 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (2258 passing tests across 272 files with passing tests) | Unit and integration tests |
...
```bash
# Passing-test count: 2258 test cases across 272 files (skipped excluded)
...
pnpm test             # Run all tests (2258 passing, 272 files with passes; skipped excluded)
pnpm lint             # ESLint
```
