...
<img src="https://img.shields.io/badge/Tests-1367%20passing-brightgreen" alt="1367 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1367 tests across 193 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1367 tests across 193 test files)
...
pnpm test             # Run all tests (1367 tests, 193 files)
pnpm lint             # ESLint
```
