...
<img src="https://img.shields.io/badge/Tests-1380%20passing-brightgreen" alt="1380 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1380 tests across 195 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1380 tests across 195 test files)
...
pnpm test             # Run all tests (1380 tests, 195 files)
pnpm lint             # ESLint
```
