...
<img src="https://img.shields.io/badge/Tests-1234%20passing-brightgreen" alt="1234 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1234 tests across 154 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1234 tests across 154 test files)
...
pnpm test             # Run all tests (1234 tests, 154 files)
pnpm lint             # ESLint
```
