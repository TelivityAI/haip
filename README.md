...
| Testing | Vitest (1278 tests across 166 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1278 tests across 166 test files)
...
pnpm test             # Run all tests (1278 tests, 166 files)
pnpm lint             # ESLint
```
