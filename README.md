...
<img src="https://img.shields.io/badge/Tests-1194%20passing-brightgreen" alt="1194 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1194 tests across 148 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1194 tests across 148 test files)
...
pnpm test             # Run all tests (1194 tests, 148 files)
pnpm lint             # ESLint
```
