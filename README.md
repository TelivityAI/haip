...
<img src="https://img.shields.io/badge/Tests-1337%20passing-brightgreen" alt="1337 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1337 tests across 183 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1337 tests across 183 test files)
...
pnpm test             # Run all tests (1337 tests, 183 files)
pnpm lint             # ESLint
```
