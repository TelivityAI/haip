...
| Testing | Vitest (1177 tests across 142 test files) | Unit and integration tests |
...
```bash
# All tests (1177 tests across 142 test files)
pnpm test
...
pnpm test             # Run all tests (1177 tests, 142 files)
