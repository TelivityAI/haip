...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1177%20passing-brightgreen" alt="1177 Tests Passing" />
...
| Testing | Vitest (1177 tests across 143 test files) | Unit and integration tests |
...
```bash
# All tests (1177 tests across 143 test files)
pnpm test
...
pnpm test             # Run all tests (1177 tests, 143 files)
