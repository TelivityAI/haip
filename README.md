...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-2175%20passing-brightgreen" alt="2175 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (2175 passing tests across 259 files with passing tests) | Unit and integration tests |
...
```bash
# Passing-test count: 2175 test cases across 259 files (skipped excluded)
...
pnpm test             # Run all tests (2175 passing, 259 files with passes; skipped excluded)
pnpm lint             # ESLint
```
