...
<img src="https://img.shields.io/badge/Tests-1278%20passing-brightgreen" alt="1278 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1278 tests across 168 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1278 tests across 168 test files)
...
pnpm test             # Run all tests (1278 tests, 168 files)
pnpm lint             # ESLint
```
