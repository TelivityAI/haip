...
<img src="https://img.shields.io/badge/Tests-1569%20passing-brightgreen" alt="1569 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1569 tests across 219 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1569 tests across 219 test files)
...
pnpm test             # Run all tests (1569 tests, 219 files)
pnpm lint             # ESLint
```
