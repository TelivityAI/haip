...
<img src="https://img.shields.io/badge/Tests-1261%20passing-brightgreen" alt="1261 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1261 tests across 162 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1261 tests across 162 test files)
...
pnpm test             # Run all tests (1261 tests, 162 files)
pnpm lint             # ESLint
```
