...
<img src="https://img.shields.io/badge/Tests-1253%20passing-brightgreen" alt="1253 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1253 tests across 160 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1253 tests across 160 test files)
...
pnpm test             # Run all tests (1253 tests, 160 files)
pnpm lint             # ESLint
```
