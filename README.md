...
<img src="https://img.shields.io/badge/Tests-1589%20passing-brightgreen" alt="1589 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1589 tests across 219 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1589 tests across 219 test files)
...
pnpm test             # Run all tests (1589 tests, 219 files)
pnpm lint             # ESLint
```
