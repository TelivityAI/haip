...
<img src="https://img.shields.io/badge/Tests-1582%20passing-brightgreen" alt="1582 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1582 tests across 221 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1582 tests across 221 test files)
...
pnpm test             # Run all tests (1582 tests, 221 files)
pnpm lint             # ESLint
```
