...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1106%20passing-brightgreen" alt="1106 Tests Passing" />
...
| Testing | Vitest (1106 tests across 132 test files) | Unit and integration tests |
...
```bash
# All tests (1106 tests across 132 test files)
pnpm test
...
pnpm test             # Run all tests (1106 tests, 132 files)
