...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-2262%20passing-brightgreen" alt="2262 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (2262 passing tests across 273 files with passing tests) | Unit and integration tests |
...
```bash
# Passing-test count: 2262 test cases across 273 files (skipped excluded)
...
pnpm test             # Run all tests (2262 passing, 273 files with passes; skipped excluded)
pnpm lint             # ESLint
```
