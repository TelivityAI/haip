...
<img src="https://img.shields.io/badge/Tests-1423%20passing-brightgreen" alt="1423 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1423 tests across 200 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1423 tests across 200 test files)
...
pnpm test             # Run all tests (1423 tests, 200 files)
pnpm lint             # ESLint
```
