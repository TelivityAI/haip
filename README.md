...
<img src="https://img.shields.io/badge/Tests-1433%20passing-brightgreen" alt="1433 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1433 tests across 202 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1433 tests across 202 test files)
...
pnpm test             # Run all tests (1433 tests, 202 files)
pnpm lint             # ESLint
```
