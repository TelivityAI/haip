...
<img src="https://img.shields.io/badge/Tests-1250%20passing-brightgreen" alt="1250 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1250 tests across 159 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1250 tests across 159 test files)
...
pnpm test             # Run all tests (1250 tests, 159 files)
pnpm lint             # ESLint
```
