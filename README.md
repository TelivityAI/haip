...
<img src="https://img.shields.io/badge/Tests-1269%20passing-brightgreen" alt="1269 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1269 tests across 166 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1269 tests across 166 test files)
...
pnpm test             # Run all tests (1269 tests, 166 files)
pnpm lint             # ESLint
```
