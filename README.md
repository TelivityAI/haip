...
| Testing | Vitest (1193 tests across 145 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1193 tests across 145 test files)
...
pnpm test             # Run all tests (1193 tests, 145 files)
pnpm lint             # ESLint
```
