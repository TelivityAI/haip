...
<img src="https://img.shields.io/badge/Tests-1349%20passing-brightgreen" alt="1349 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1349 tests across 187 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1349 tests across 187 test files)
...
pnpm test             # Run all tests (1349 tests, 187 files)
pnpm lint             # ESLint
```
