...
<img src="https://img.shields.io/badge/Tests-1408%20passing-brightgreen" alt="1408 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1408 tests across 199 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1408 tests across 199 test files)
...
pnpm test             # Run all tests (1408 tests, 199 files)
pnpm lint             # ESLint
```
