...
<img src="https://img.shields.io/badge/Tests-1266%20passing-brightgreen" alt="1266 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1266 tests across 165 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1266 tests across 165 test files)
...
pnpm test             # Run all tests (1266 tests, 165 files)
pnpm lint             # ESLint
```
