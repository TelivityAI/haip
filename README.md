...
<img src="https://img.shields.io/badge/Tests-1260%20passing-brightgreen" alt="1260 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1260 tests across 161 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1260 tests across 161 test files)
...
pnpm test             # Run all tests (1260 tests, 161 files)
pnpm lint             # ESLint
```
