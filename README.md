...
| Testing | Vitest (1194 tests across 146 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1194 tests across 146 test files)
...
pnpm test             # Run all tests (1194 tests, 146 files)
pnpm lint             # ESLint
```
