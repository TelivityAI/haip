...
<img src="https://img.shields.io/badge/Tests-1525%20passing-brightgreen" alt="1525 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1525 tests across 216 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1525 tests across 216 test files)
...
pnpm test             # Run all tests (1525 tests, 216 files)
pnpm lint             # ESLint
```
