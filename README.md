...
<img src="https://img.shields.io/badge/Tests-1404%20passing-brightgreen" alt="1404 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1404 tests across 198 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1404 tests across 198 test files)
...
pnpm test             # Run all tests (1404 tests, 198 files)
pnpm lint             # ESLint
```
