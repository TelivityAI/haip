...
<img src="https://img.shields.io/badge/Tests-1429%20passing-brightgreen" alt="1429 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1429 tests across 201 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1429 tests across 201 test files)
...
pnpm test             # Run all tests (1429 tests, 201 files)
pnpm lint             # ESLint
```
