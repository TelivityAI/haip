...
<img src="https://img.shields.io/badge/Tests-1364%20passing-brightgreen" alt="1364 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1364 tests across 192 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1364 tests across 192 test files)
...
pnpm test             # Run all tests (1364 tests, 192 files)
pnpm lint             # ESLint
```
