...
<img src="https://img.shields.io/badge/Tests-1298%20passing-brightgreen" alt="1298 Tests Passing" />  <img src="https://img.shields.io/badge/AI%20Agents-12%20built--in-blueviolet" alt="12 AI Agents" />
</p>
...
| Testing | Vitest (1298 tests across 174 test files) | Unit and integration tests || Build | tsup (packages) + Vite (dashboard) + nest build (API) | Fast builds |
...
```bash
# All tests (1298 tests across 174 test files)
...
pnpm test             # Run all tests (1298 tests, 174 files)
pnpm lint             # ESLint
```
