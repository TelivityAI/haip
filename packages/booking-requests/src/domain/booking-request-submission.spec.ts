...
// `@nestjs/common/constants` isn't a resolvable ESM subpath export — inline
// the well-known internal metadata key (@nestjs/common `constants.ts`).
...
import { SubmitBookingRequestDto } from '../http/dto/submit-booking-request.dto.js';
